...
function createBubbleMap(data) {
    ...
    //.domain(volumeExtent.reverse());

    const colorScale = d3.scaleThreshold()
    .domain([1, 10,50,100]) // Adjust these thresholds based on your data
    .range(["#FFD739", "#C299FC", "#9852F9", "#6807F9"]); // Custom colors for each range
